...
def run_portfolio_tracker():
    ...
    if schone_sheets is not None:
        ...
        huidige_waarde = alle_huidige_waarden_berekenen(
            totaal_aandelen, huidige_prijzen
        )
        ...
        totaalwaarden_portfolio = totaalwaarde_portfolio_berekenen(
            alle_aandelen_compleet
        )
        ...
        return (aandelen_compleet_inclusief_gewicht, totaalwaarden_portfolio)
